...
async def t_house_rules():
    ...
    # Warm Feel sets figures in the same serif as the text, with tabular numerals
    # — Georgia has no slashed zero to ask for, and asking for one the face does
    # not have is a declaration that means nothing. What this probe is actually
    # protecting is that columns of numbers line up, which tabular-nums is.
    check("figures have tabular numerals",
          "tabular-nums" in blob and "--font-data" in blob, "")
